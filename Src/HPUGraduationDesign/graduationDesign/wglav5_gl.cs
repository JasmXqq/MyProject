...
// ############################################################################
//
// The GL class wraps various gl*() functions found in the opengl32
// library on the Windows platform.
//
// The GL class is part of a family of classes in the WGLAV5 namespace:
//
...
namespace WGLAV5
{
	public class GL
	{
		...
		*/
		...
		[DllImport(GL_DLL)] public unsafe static extern String glGetString              ( uint name );
		...
		return( glAreTexturesResident( n, p_textures, p_residences ) );
		} } 
		}
